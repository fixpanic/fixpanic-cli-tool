...
echo "  📦 Actions: https://github.com/fixpanic/opssquad-cli-tool/actions"
echo "  📋 Releases: https://github.com/fixpanic/opssquad-cli-tool/releases"
echo "  🏷️  Tags: https://github.com/fixpanic/opssquad-cli-tool/tags"
echo ""
print_info "Test the new release:"
echo "  curl -fsSL https://install.opssquad.com/install.sh | bash"
echo ""
